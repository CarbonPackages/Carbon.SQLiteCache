...
* Create an [issue](https://github.com/jonnitto/Carbon.SQLiteCache/issues) on GitHub, if you have found a bug
...
* Submit an [issue](https://github.com/jonnitto/Carbon.SQLiteCache/issues), assuming one does not already exist.
